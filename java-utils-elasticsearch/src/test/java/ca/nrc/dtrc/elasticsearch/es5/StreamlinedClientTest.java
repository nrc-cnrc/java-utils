...
import ca.nrc.dtrc.elasticsearch.es5.ESTestHelpers.PlayLine;
import ca.nrc.dtrc.elasticsearch.es5.request.Aggs;
import ca.nrc.dtrc.elasticsearch.es5.request.Query;
import ca.nrc.dtrc.elasticsearch.es5.request.Sort;
...
//		String gotJson = client.moreLikeThisJsonBody(homer.getClass().getName(), homerMap);
		String gotJson = client.moreLikeThisJsonBody(homer.getClass().getName(), homerMap);
		String expJson =
				"{\"query\":{\"more_like_this\":{\"max_query_terms\":12,\"min_doc_freq\":1,\"min_term_freq\":1,\"fields\":[\"firstName\",\"id\",\"lang\",\"surname\"],\"like\":{\"_index\":\"es-test\",\"_type\":\"ca.nrc.dtrc.elasticsearch.es5.StreamlinedClientTest$Person\",\"doc\":{\"lang\":\"en\",\"id\":\"homersimpson\",\"firstName\":\"homer\",\"surname\":\"simpson\"}}}},\"highlight\":{\"order\":\"score\",\"fields\":{\"content\":{\"type\":\"plain\"},\"shortDescription\":{\"type\":\"plain\"}}}}";
	...
	public void test__bulkIndex__HappyPath() throws Exception {
		...
		File jsonFile = ResourceGetter.copyResourceToTempLocation("test_data/ca/nrc/dtrc/elasticsearch/es5/small_index_content.json");
		Boolean force = true;
	...
	public void test__bulkIndex__LoadTwoFilesIntoSameIndexWithSameDefinition__DocsShouldBeAdded() throws Exception {
		...
		jsonFile = ResourceGetter.copyResourceToTempLocation("test_data/ca/nrc/dtrc/elasticsearch/es5/other_small_index_content.json");
		esClient.bulkIndex(jsonFile.getAbsolutePath(), null, null, force);
